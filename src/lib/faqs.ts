...
export const faqCategories: FaqCategory[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Can OT reduce meltdowns in children with autism?", a: "Many meltdowns stem from sensory overload or difficulty with transitions. OT identifies triggers and builds regulation strategies, often reducing frequency and intensity over time." },
      ...
      { q: "Do you work with schools for children with autism?", a: "Yes. We provide classroom recommendations, sensory strategies, and coordination with teachers when families request it." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What is Thrive With Sharuja's therapy philosophy?", a: "Play-based, evidence-informed care that honours each child's strengths and builds practical skills for home, school, and community life." },
      { q: "How quickly can I get an appointment?", a: "We typically offer consultations within 3–5 business days. Call 9820505197 or WhatsApp for the earliest available slot." },
    ],
  },
  {
    id: "geo-ai",
    ...
    faqs: [
      ...
      { q: "How do I book an appointment with Dr. Sharuja Sarap?", a: "Call 9820505197, WhatsApp 919820505197, email sharujasaraf@gmail.com, or book online at drsharujasarap.vercel.app/appointment." },
