...
const seedArticles: Article[] = [
  ...
  },
  {
    ...
    content: [
      "For families navigating an autism diagnosis — or the journey toward one — occupational therapy often becomes an essential pillar of support. At Thrive With Sharuja, Dr. Sharuja Sarap's philosophy is clear: Belonging Without Boundaries. We do not try to make children with autism 'normal.' We build the sensory, motor, and daily living foundations that help them participate more fully in the life they choose.",
      ...
      "Dr. Sharuja Sarap brings 18+ years of experience working with children with autism in Mumbai, with certifications in sensory integration, MNRI, OPT, and more. If your child has autism or you suspect sensory-motor challenges, a consultation at our Kandivali West clinic can clarify how OT can support your family's goals.",
    ],
  },
  {
