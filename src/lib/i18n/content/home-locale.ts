...
export const hiHomeContent: LocaleContent["home"] = {
  ...
  aboutPreview: {
    ...
    title: "नमस्ते,",
    bio: "मैं 18+ वर्षों के अनुभव वाली व्यावसायिक चिकित्सक हूँ, जो विकासात्मक, संवेदी और न्यूरोलॉजिकल आवश्यकताओं वाले बच्चों का समर्थन करती हूँ। मेरा कार्य बच्चों को घर, स्कूल और समुदाय की रोज़मर्रा की गतिविधियों में आत्मविश्वास से भाग लेने में मदद करता है।",
    credentials: [
      "मैं डॉ. शारुजा हूँ",
...
export const mrHomeContent: LocaleContent["home"] = {
  ...
  aboutPreview: {
    kicker: "माझ्याबद्दल",
    title: "नमस्कार,",
    bio: "मी १८+ वर्षांच्या अनुभवाची व्यावसायिक थेरपिस्ट आहे, विकासात्मक, संवेदी आणि न्यूरोलॉजिकल गरजा असलेल्या मुलांना आधार देते. माझे काम मुलांना घरी, शाळेत आणि समाजातील दैनंदिन क्रियांमध्ये आत्मविश्वासाने सहभागी होण्यास मदत करते.",
    credentials: [
      "मी डॉ. शरुजा आहे",
