...
const hi: Phase3Content = {
  ...
  gallery: {
    ...
    items: [
      {
        title: "गर्म थेरेपी कक्ष",
        category: "Therapy Room",
        alt: "कोमल बैठक और व्यवस्थित उपकरणों वाला शांत बाल OT कक्ष",
      },
      {
        title: "मूल्यांकन और परीक्षण स्थान",
        category: "Assessment Area",
        alt: "विकासात्मक और सेंसरी-मोटर स्क्रीनिंग के लिए बच्चे के अनुकूल क्षेत्र",
      },
      {
        title: "जल चिकित्सा सत्र",
        category: "Aquatic Therapy",
        alt: "पानी में संतुलन, ताकत और सेंसरी नियमन के लिए पर्यवेक्षित जल चिकित्सा",
      },
      {
        title: "सेंसरी उपकरण",
        category: "Therapy Equipment",
        alt: "झूले, बनावट वाले उपकरण और भारित सहारे सहित सेंसरी एकीकरण उपकरण",
      },
      {
        title: "बच्चों के अनुकूल खेल क्षेत्र",
        category: "Child-Friendly Environment",
        alt: "थेरेपी को सुरक्षित और मज़ेदार बनाने वाला उज्ज्वल खेल क्षेत्र",
      },
      {
        title: "सेंसरी जिम",
        category: "Therapy Room",
        alt: "चढ़ाई संरचनाओं और गति उपकरणों वाला इनडोर सेंसरी जिम",
      },
    ],
  },
  library: {
...
const mr: Phase3Content = {
  ...
  gallery: {
    ...
    items: [
      {
        title: "उबदार थेरपी खोली",
        category: "Therapy Room",
        alt: "मऊ बसण्याची जागा आणि व्यवस्थित साधनांसह शांत बाल OT खोली",
      },
      {
        title: "मूल्यांकन आणि तपासणी जागा",
        category: "Assessment Area",
        alt: "विकासात्मक आणि sensory-motor screening साठी मुलांसाठी अनुकूल क्षेत्र",
      },
      {
        title: "जलचिकित्सा सत्र",
        category: "Aquatic Therapy",
        alt: "पाण्यात संतुलन, शक्ती आणि sensory नियमनासाठी पर्यवेक्षित जलचिकित्सा",
      },
      {
        title: "Sensory उपकरण",
        category: "Therapy Equipment",
        alt: "दोलके, textured साधने आणि weighted supports सह sensory integration उपकरण",
      },
      {
        title: "मुलांसाठी अनुकूल खेळ क्षेत्र",
        category: "Child-Friendly Environment",
        alt: "थेरपी सुरक्षित आणि मजेदार वाटावी म्हणून उजळ खेळ क्षेत्र",
      },
      {
        title: "Sensory Gym",
        category: "Therapy Room",
        alt: "चढाई संरचना आणि movement equipment असलेले indoor sensory gym",
      },
    ],
  },
  library: {
