...
export const hi: Messages = {
  ...
  forms: {
    ...
    appointment: {
      ...
      age: "उम्र *",
      gender: "लिंग",
      genderOptions: ["लड़का", "लड़की", "बताना नहीं चाहते"],
      primaryConcern: "परामर्श के लिए मुख्य चिंता *",
      submit: "परामर्श अनुरोध भेजें",
      submitting: "भेजा जा रहा है...",
      successTitle: "धन्यवाद — हमें आपका अनुरोध मिल गया!",
      successMessage: "आपकी अपॉइंटमेंट की पुष्टि के लिए हम जल्द ही आपसे संपर्क करेंगे।",
      whatsappUs: "हमें WhatsApp करें",
      error: "कुछ गड़बड़ हो गई। कृपया सीधे 9820505197 पर कॉल करें।",
      errors: {
        parentName: "कृपया अभिभावक का नाम भरें",
        phone: "कृपया सही फ़ोन नंबर भरें",
        childName: "कृपया बच्चे का नाम भरें",
        age: "कृपया बच्चे की उम्र भरें",
        primaryConcern: "कृपया अपनी मुख्य चिंता बताएँ",
      },
    },
    screening: {
      parentName: "अभिभावक का नाम *",
