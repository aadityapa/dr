          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-12 lg:items-start lg:gap-8">
            ...
            <div className="lg:col-span-3">
              <Image
                ...
                width={150}
                height={172}
                className="h-36 w-auto drop-shadow-[0_2px_12px_rgba(255,255,255,0.25)]"
              />
              <p className="mt-2 text-xs text-white/60">{messages.site.title}</p>
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <Button
                  asChild
                  size="sm"
                  className="h-8 bg-white px-3 text-xs text-[color:var(--color-sage-dark)] hover:bg-white/90"
                >
