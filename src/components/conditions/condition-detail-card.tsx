...
export function ConditionDetailCard({ condition, labels, id, hideTitle }: ConditionDetailCardProps) {
  return (
    <article
      id={id}
      className="scroll-mt-28 rounded-[1.75rem] border border-white/60 bg-white/70 px-6 py-8 shadow-lg shadow-[color:var(--brand-green)]/5 backdrop-blur-md md:px-10 md:py-10"
    >
      {hideTitle ? null : (
