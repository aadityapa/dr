          ...
          return (
            <li key={condition.slug}>
              <Link
                ...
                className="group flex items-center justify-between gap-4 rounded-2xl border px-5 py-4 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md md:px-6 md:py-5"
                style={{
