...
/**
 * Soft floating color blobs for hero backgrounds.
 * Always renders the same DOM on server and client — only animation is gated
 * by reduced-motion, so hydration never sees a missing sibling.
 */
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      <motion.div
        ...
        animate={reduced ? undefined : { y: [0, -20, 0], x: [0, 12, 0] }}
      ...
      <motion.div
        ...
        animate={reduced ? undefined : { rotate: [0, 8, 0], scale: [1, 1.05, 1] }}
