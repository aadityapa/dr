...
import { Brain, Heart, Sparkles, Target, Waves } from "lucide-react";
...
const FLOAT_ICONS = [
  ...
  { Icon: Waves, color: "text-[#3D7AB5]", delay: 0.4, x: "68%", y: "12%" },
  { Icon: Sparkles, color: "text-[#D4845C]", delay: 0.8, x: "78%", y: "58%" },
  { Icon: Heart, color: "text-[#C45A82]", delay: 1.2, x: "22%", y: "68%" },
  { Icon: Target, color: "text-[#7B5BB5]", delay: 1.6, x: "52%", y: "42%" },
] as const;

const TRUST_ICONS = [Sparkles, Target, Heart] as const;

export function PremiumExpertiseHero({ shells }: Pick<ExpertisePageProps, "shells">) {
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#FFFDF9] via-[#FAF8F4] to-[#F9FCFB] px-4 py-16 md:px-8 md:py-24">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        >
          ...
          <p className="mt-6 max-w-xl whitespace-pre-line text-base leading-relaxed text-[#444] md:text-lg">
            {intro.understanding}
          </p>
